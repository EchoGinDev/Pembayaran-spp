...
<ul class="topnav">
  ...
  <li><a href="add-pembayaran.php">Tambah Pembayaran</a></li>
</ul>

<center><h1>Pembayaran SPP</h1></center>
...
while($user_data = mysqli_fetch_array($result)) {         
    ...
    echo "<td><a href='edit-pembayaran.php?id=$user_data[id_pembayaran]'>Edit</a> | <a href='delete-pembayaran.php?id=$user_data[id_pembayaran]'>Delete</a></td></tr>";
}
?>
</table>
